...
1.  Using the human data the exponential growth module, fit a linear regression with likelihood
2.  Now fit the non-linear version. In other words, don't log transform. Use the model directly.
